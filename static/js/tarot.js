...
// ============================================================
        ...
        function init() {
            ...
            // Force entry after 2 seconds if not already triggered
            setTimeout(() => {
                if (!entryTriggered) {
...
console.log('🔍 Tarot.js loaded, entryTriggered:', entryTriggered, 'scene:', scene);

// Force entry after 3 seconds if not triggered
setTimeout(() => {
    console.log('⏰ Auto‑entry check... entryTriggered:', entryTriggered);
    if (!entryTriggered) {
        console.warn('⚠️ Auto‑entry fallback triggered');
        enterRoom();
    }
...
// Also log when click is detected
document.addEventListener('click', () => {
    console.log('🖱️ Click detected, entryTriggered:', entryTriggered, 'scene:', scene);
    // ... (your existing click handler is already there)
});